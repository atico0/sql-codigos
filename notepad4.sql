...
/*1*/
select count(*),departamento from funcionarios where departamento like '%roupa%' or departamento like '%filme%' group by departamento;
select * from funcionarios where departamento like '%filme%' or departamento like '%roupas%';

/*2*/
select count(*),departamento from funcionarios where departamento like '%lar%' or departamento like '%filme%' group by departamento;
select * from funcionarios where departamento like '%lar%' or departamento like '%filme%';
/*3*/
select count(*),sexo, departamento from funcionarios where sexo like 'm%' or departamento like 'jardim' group by sexo;
select * from funcionarios where departamento like '%jardim%' or sexo like 'm%';
